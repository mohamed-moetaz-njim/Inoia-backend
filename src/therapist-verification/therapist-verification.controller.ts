...
export class TherapistVerificationController {
  constructor(private readonly verificationService: TherapistVerificationService) {}
  ...
  submitRequest(
    ...
    return this.verificationService.submitRequest(userId, certificationReference);
  }
